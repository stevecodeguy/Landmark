  ...
  return (
    <div className="footer">
      ...
      <footer>
        ...
        <a href="https://www.google.ca/maps/place/1400+Robson+St,+Vancouver,+BC+V6G+1B9/@49.2880923,-123.1329422,17z/data=!3m1!4b1!4m5!3m4!1s0x5486718773f2f537:0xc8ade08187e406ce!8m2!3d49.2880923!4d-123.1307536" >
          <p>1400 Robson St. Vancouver, BC</p>
        </a>
        <div>
          <p>604 566 2288 &#160;|</p>
          <a href="mailto:info@landmarkonrobson.com" >
        ...
        <div className="lowerLinks">
          ...
          <div className="logos">
            <a href="http://www.asiastandardamericas.com/">
              <img className="asia" src={asia} alt="Asia Standard Americas" />
            </a>
            <a href="http://magnumprojects.ca/">
